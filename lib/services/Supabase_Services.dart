...
class SupabaseService extends GetxService {
  static const String _supabaseUrl = 'https://wpuulmyghraznktpsvkg.supabase.co';
  static const String _supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6IndwdXVsbXlnaHJhem5rdHBzdmtnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDE3MTA4OTYsImV4cCI6MjA1NzI4Njg5Nn0.4AHXRomMDX5hcOP7870t6CduDyFf7BzwBKUNPhpOwAY';
    // bool _isInitialized = false;
  late final SupabaseClient _client;
  User? currentUser;

  Future<SupabaseService> init() async {
    _client = Supabase.instance.client; // ✅ استخدم العميل الحالي فقط
